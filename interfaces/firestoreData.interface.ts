...
export class FirestoreDataMigration<
    TPrevious extends FirestoreData,
    TNext extends FirestoreData,
> {
    ...
    constructor(
        ...
        const previousInstance = migration({
            version: previousVersion,
        } as TPrevious);
        const nextInstance = migration({
            version: previousVersion,
        } as TPrevious);
